...
export interface Workflow {
  ...
  created_at: number
  updated_at: number
  /** View-layer group collapse metadata (engine ignores at execution) */
  _groups?: WorkflowGroupMeta[]
}

/** Serialized group entry in workflow JSON */
...
/** Stepwise routing edge (_lg_edges schema field) */
