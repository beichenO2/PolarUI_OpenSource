...
async function bootstrap() {
  // SSoT: ~/Polarisor/PolarUI/node-defs/ → symlink → public/node-defs/ → Vite serves as /node-defs/*
  ...
  if (loaded === 0) {
    ...
    console.error('[PolarUI] 请确认 public/node-defs/ 目录 symlink 指向 ~/Polarisor/PolarUI/node-defs/')
  }
