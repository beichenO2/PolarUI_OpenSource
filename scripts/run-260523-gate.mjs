...
const steps = [
  ...
  { name: 'lg-pluripotent', cmd: 'npx', args: ['tsx', 'scripts/run-lg-pluripotent-smoke.mjs'] },
  { name: 'lg-canvas', cmd: 'npx', args: ['tsx', 'scripts/run-lg-canvas-smoke.mjs'] },
  { name: 'lg-export-wf', cmd: 'npx', args: ['tsx', 'scripts/run-lg-export-wf-smoke.mjs'] },
