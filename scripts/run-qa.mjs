...
const STEPS = [
  ...
  { id: 'test:canvas', cmd: 'node', args: ['--import', 'tsx', '--test', 'tests/canvas/graph-groups.test.ts', 'tests/canvas/group-suggest.test.ts', 'tests/canvas/wire-routing.test.ts', 'tests/canvas/wire-routing-snapshot.test.ts', 'tests/canvas/canvas-dblclick.test.ts'] },
